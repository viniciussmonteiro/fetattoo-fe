...
export const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Envie no WhatsApp ou formulário: ideia, tamanho aproximado, região do corpo e referências. Com isso já consigo retornar faixa de investimento e disponibilidade." 
  },
  {
    id: 2,
    question: "Qual o valor mínimo?",
    answer:
      "O valor mínimo atual para sessão é de R$ 350, variando conforme complexidade, tempo e técnica." 
  },
  {
    id: 3,
    question: "Faz retoque?",
    answer:
      "Sim. O primeiro retoque é avaliado sem custo em até 60 dias após cicatrização, seguindo orientações de cuidado." 
  },
  {
    id: 4,
  ...
  },
  {
    ...
    answer:
      "Faço sim, mediante avaliação da tatuagem antiga. Em alguns casos, pode ser necessário clareamento prévio." 
  },
  {
    id: 9,
    question: "Atende por ordem de chegada ou só com hora marcada?",
    answer:
      "Atendimento somente com horário agendado para manter qualidade e tempo dedicado ao seu projeto." 
  },
  {
    id: 10,
    question: "Posso tatuar grávida ou amamentando?",
    answer:
      "Por segurança, não realizo tatuagem em gestantes e pessoas em fase de amamentação imediata. Avaliamos caso a caso após esse período." 
  }
];
